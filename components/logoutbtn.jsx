...
export const LogoutButton = ({  linkPage }) => {
  const router = useRouter();
  return (
    <Link href={linkPage}>
      <div
        className={`flex justify-center w-[120px] h-[40px] p-[2px] gap-[10px] border-none rounded-md z-0 hover:bg-white cursor-pointer relative ${
